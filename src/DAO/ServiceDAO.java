...
public class ServiceDAO {
    ...
    public ArrayList<Service> getServiceByName(String name) {
        ...
        try {
            ...
            String sql = "SELECT * FROM DichVu where tenDichvu COLLATE Latin1_General_CI_AI LIKE ?";
            ...
            while (rs.next()) {
                lst.add(new Service(rs.getString(1), rs.getString(2), new TypeOfService(rs.getString(3)), rs.getString(4),rs.getInt(5), rs.getDouble(6)));
            }
        } catch (SQLException e) {
            e.printStackTrace();
        } finally {
